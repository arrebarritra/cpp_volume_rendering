...
void RaytracingIsoImplKD::FillParameterSpace(ParameterSpace& pspace)
{
    ...
    pspace.AddParameterDimension(new ParameterRangeInt("MaxTraversalLevel", &m_u_maxTraversalLevel, kdg.k - 10, kdg.k - 1, 3));
    pspace.AddParameterDimension(new ParameterRangeFloat("SearchStepSize", &m_u_searchStepSize, 0.01, 0.51, 0.2));
}
